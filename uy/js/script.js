/**
 * DólarCTD — Script de Uruguay (UYU)
 * API: https://uy.dolarapi.com/v1/cotizaciones
 */
document.addEventListener('DOMContentLoaded', function () {
    ...
    const SIMBOLO   = '$';
    const DECIMALES = 2;
    const API_URL   = 'https://uy.dolarapi.com/v1/cotizaciones';
    const UPDATE_MS = DolarCTD.UPDATE_MS;

    const ICONOS_MONEDA = {
        USD: 'fa-dollar-sign', EUR: 'fa-euro-sign', ARS: 'fa-money-bill',
        BRL: 'fa-money-bill-wave', CLP: 'fa-coins', GBP: 'fa-sterling-sign',
        CHF: 'fa-landmark', PYG: 'fa-coins', XAU: 'fa-gem',
    };
        ...
        try {
            ...
            const monedas = datos.map(d => {
                ...
                return {
                    ...
                    compra,
                    venta,
                    promedio: (promedio !== compra) ? promedio : null,
            ...
            console.error('[DólarCTD UY] Error:', err);
            DolarCTD.mostrarError('general-cards', 'Error al cargar cotizaciones de Uruguay');
        }
    }
